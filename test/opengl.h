...
typedef void __stdcall gl_uniform_matrix_2fv(GLint location, GLsizei count, GLboolean transpose,
					     const GLfloat *value);
typedef void __stdcall gl_uniform_matrix_3fv(GLint location, GLsizei count, GLboolean transpose,
					     const GLfloat *value);
typedef void __stdcall gl_uniform_matrix_4fv(GLint location, GLsizei count, GLboolean transpose,
					     const GLfloat *value);
typedef void __stdcall gl_uniform_matrix_2x3fv(GLint location, GLsizei count, GLboolean transpose,
					       const GLfloat *value);
typedef void __stdcall gl_uniform_matrix_3x2fv(GLint location, GLsizei count, GLboolean transpose,
					       const GLfloat *value);
typedef void __stdcall gl_uniform_matrix_2x4fv(GLint location, GLsizei count, GLboolean transpose,
					       const GLfloat *value);
typedef void __stdcall gl_uniform_matrix_4x2fv(GLint location, GLsizei count, GLboolean transpose,
					       const GLfloat *value);
typedef void __stdcall gl_uniform_matrix_3x4fv(GLint location, GLsizei count, GLboolean transpose,
					       const GLfloat *value);
typedef void __stdcall gl_uniform_matrix_4x3fv(GLint location, GLsizei count, GLboolean transpose,
					       const GLfloat *value);
...
typedef void __stdcall gl_buffer_sub_data(GLenum target, GLintptr offset, GLsizeiptr size, const GLvoid* data);
typedef void __stdcall gl_vertex_attrib_pointer(GLuint index, GLint size, GLenum type, GLboolean normalized,
...
// OpenGL 4.2
typedef void __stdcall gl_tex_storage_2d(GLenum target, GLsizei levels, GLenum internalformat, GLsizei width,
					 GLsizei height);

// OpenGL 4.3
typedef void __stdcall gl_bind_vertex_buffer(GLuint bindingindex, GLuint buffer, ptrdiff_t offset,
					     ptrdiff_t stride);
typedef void __stdcall gl_vertex_attrib_format(GLuint attribindex, GLint size, GLenum type,
...
typedef void __stdcall gl_vertex_array_vertex_buffer(GLuint vaobj, GLuint bindingindex, GLuint buffer,
						     GLint* offset, GLsizei stride);
typedef void __stdcall gl_vertex_array_attrib_binding(GLuint vaobj, GLuint attribindex, GLuint bindingindex);
typedef void __stdcall gl_vertex_array_attrib_ib_format(GLuint vaobj, GLuint attribindex, GLint size,
...
typedef void __stdcall gl_texture_storage_2d(GLuint texture, GLsizei levels, GLenum internalformat,
					     GLsizei width, GLsizei height);
typedef void __stdcall gl_texture_sub_image_2d(GLuint texture, GLint level, GLint xoffset, GLint yoffset,
					       GLsizei width, GLsizei height, GLenum format, GLenum type,
					       const void* pixels);
typedef void __stdcall gl_texture_parameter_i(GLuint texture, GLenum pname, GLint param);
typedef void __stdcall gl_named_buffer_sub_data(GLuint buffer, GLintptr offset, GLsizei size, const void* data);
...
static gl_texture_parameter_i* glTextureParameteri;
